<div class="modal fade" id="createAchievement" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg bg-light rounded">
        <div class="modal-content bg-light rounded">
            <div class="modal-header">
                <h2 class="col-5 fw-light mt-3 mb-3">Adicionar conquista</h1>
            ...
            <div class="modal-body">
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <div class='col-sm-12'>
                            <input required type="number" placeholder="Ano da conquista" class="form-control p-3  mt-3" name="year" id='year'> <br>
                        </div>
                        <div class='col-sm-12'>
                            <textarea placeholder="texto da conquista" name="text" id="text" cols="10" rows="3" class="form-control p-3  mt-3"></textarea>
                        </div>
