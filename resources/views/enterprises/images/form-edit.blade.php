    ...
    <div class="modal-dialog modal-lg bg-light rounded">
        <div class="modal-content bg-light rounded">
            <div class="modal-header">
                <h2 class="col-5 fw-light mt-3 mb-3">Editar imagem</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" action="" id='form-edit-image' enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class='col-sm-12'>
                            ...
                            <img src='' id='preview_image' width='100%'>
                            <input name="image" id="edit-image" type='file' class="form-control p-3  mb-3">
                        </div>
                        ...
                        <div class='col-sm-12'>
                            ...
                            <div class='row mt-3'>
                                <div class='col-sm-4'>
                                    <input type='radio' value='0' name='type' id='edit-type-0'>
                                    <label for='type-0'>Apartamento / Terreno</label>
                                </div>

                                <div class='col-sm-4'>
                                    <input type='radio' value='1' name='type' id='edit-type-1'>
                                    <label for='type-1'>Área comum</label>
                                </div>

                                <div class='col-sm-4'>
                                    <input type='radio' value='2' name='type' id='edit-type-2'>
