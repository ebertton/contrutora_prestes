@php $paginaNome = 'Erro 404 '; @endphp
@include('site.components.header')
    <main id="erro-404">
        <h1 class="position-absolute color-transparente">Erro 404</h1>
        <section id="sorry">
            <div class="container pt-5">
                <div class="row py-5">
                    <div class="col-12 text-center py-5">
                        <img src="../assets/img/banner-404.png" alt="Banner erro 404" class="img-fluid">
